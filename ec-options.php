...
class EcOptions {
  ...
  public function pageContent() {
      ...
      <div class="wrap">
          ...
          <p><?php echo __('Plugin is used by inserting shortcode <b>[encryption-contest]</b> anywhere on page. General settings are set right here. You can create tasks for all users ', 'encrypt') .'<a href="/wp-admin/admin.php?page=ec-menu">'. __('in main menu', 'encrypt')?></a>.</p>     
